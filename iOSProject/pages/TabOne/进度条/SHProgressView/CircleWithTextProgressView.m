...
//@synthesize topLineCollor = _topLineCollor;
//- (UIColor *)topLineCollor
//{
//    return _topLineCollor;
//}
- (void)setUpperLineCollor:(UIColor *)upperLineCollor
{
    _upperShapeLayer.strokeColor     = upperLineCollor.CGColor;
}
