...
- (void)handlerTextFieldSelect:(UITextField *)textField {
    switch (textField.tag) {
        ...
        case 6:
        {
            ...
            [BRStringPickerView showStringPickerWithTitle:@"学历" dataSource:dataSource defaultSelValue:textField.text isAutoSelect:YES themeColor:[UIColor redColor] resultBlock:^(id selectValue) {
